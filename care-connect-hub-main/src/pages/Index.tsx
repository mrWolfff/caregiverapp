        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-foreground mb-6 leading-tight">
              Find Trusted Caregivers in Your{' '}
              <span className="text-primary">Community</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              CareConnect bridges the gap between families seeking quality care and dedicated caregivers ready to help. Simple, safe, and compassionate.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We make finding quality care simple and stress-free.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2">
              <CardContent className="p-8 md:p-12">
                ...
                <p className="text-muted-foreground mb-6">
                  Join thousands of families and caregivers already connected through CareConnect.
                </p>
                <ul className="space-y-3 mb-8">
                  {['Free to create an account', 'No commitment required', 'Find care in your area'].map((item) => (
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-heading font-bold">CareConnect</span>
            </div>
